...
- **`validate.yml`**: On PRs and main-branch pushes that modify any guide or script file, `test-vectors/`, or platform entry files (SKILL.md, AGENTS.md, etc.); also runs `python test-vectors/verify.py` (requires `pycryptodome`)
