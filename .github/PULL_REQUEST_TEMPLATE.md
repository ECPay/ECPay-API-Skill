...
- [ ] 若修改加密實作：已執行 `pip install pycryptodome && python test-vectors/verify.py` 確認全部 18 個測試向量通過
...
- [ ] SKILL.md / SKILL_OPENAI.md / README.md / OPENAI_SETUP.md / OPENCLAW_SETUP.md / AGENTS.md / CODEX_SETUP.md / GEMINI.md / GEMINI_SETUP.md 版本號一致（可執行 `bash scripts/validate-version-sync.sh` 自動驗證）
