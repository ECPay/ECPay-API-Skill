...
<!-- AI Section Index（供 AI 部分讀取大檔案用，2026-03-23 校準）
Python: line 252-299 | Node.js: line 300-348 | TypeScript: line 349-403
Java: line 404-490 | C#: line 491-553 | Go: line 554-668
C: line 669-872 | C++: line 873-1027 | Rust: line 1028-1094
Swift: line 1095-1196 | Kotlin: line 1197-1253 | Ruby: line 1254-1303
Test vectors: line 1304-1470 | 常見錯誤: line 1471-1479
...
> 從 `scripts/SDK_PHP/src/Services/AesService.php` 精確對應(`encrypt()` @ line 91-104、`decrypt()` @ line 41-56)
...
以下實作從 `AesService.php`(`encrypt()` @ line 91-104、`decrypt()` @ line 41-56)精確翻譯,涵蓋 Python、Node.js、TypeScript、Java、C#、Go、C、C++、Rust、Swift、Kotlin、Ruby。
...
- PHP SDK 原始碼:`scripts/SDK_PHP/src/Services/AesService.php`(`encrypt()` @ line 91-104、`decrypt()` @ line 41-56、`encryptData()` @ line 120、`decryptData()` @ line 73)
